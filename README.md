...
4. **permute**: <br/>
 This program, for a given $G$-invariant simplicial complex $K$ and an element $h$ in the normalizer of $G$, produces the $G$-invariant simplicial complex $h(K)$. This simple script is conveniently used to decompose the list of 24 combinatorial manifolds from Theorem 2.2 of [G] (which is produced by **find**) into 4 orbits with respect to the group $C_2\times C_3$ generated by the sign reversal and the Frobenius automorphism.
6. **num_neighbors**: <br/>

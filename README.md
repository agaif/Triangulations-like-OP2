...
+ File **HP2_15_G_component.dat** contain the lists of all maximal simplices of $15$-vertex triangulations of $\mathbb{HP}^2$ that consitute the connected component $\mathcal{G}_0$ of the Brehm--K\"uhnel triangulation in the triple flip graph $\mathcal{G}$, see Section 8 of [G3].

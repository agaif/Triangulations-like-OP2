...
bool take_one_orbit (int_orbit number) {
    ...
    /***** writing log ****/
    if (current_level == 1) {
        cout << simplex_to_string(number_of_vertices, orbit_rep[number]) << " eventually taken\n";
    } else {
        cout << simplex_to_string(number_of_vertices, orbit_rep[number]) << " taken at level " << (int) current_level << "\n";
    }
    /***** end writing log ****/
...
bool remove_one_orbit (int_orbit number) {
    ...
    /***** writing log ****/
    if (current_level == 1) {
        cout << simplex_to_string(number_of_vertices, orbit_rep[number]) << " eventually removed\n";
    } else {
        cout << simplex_to_string(number_of_vertices, orbit_rep[number]) << " removed at level " << (int) current_level << "\n";
    }
    /***** end writing log ****/
...
bool increase_level() {
    ...
    /***** writing log ****/
    cout << "(" << orbits_taken.size() << ", " << orbits_indeterminate.size() << ", "
         << number_of_orbits - orbits_taken.size() - orbits_indeterminate.size()
         << ") taken/indeterminate/removed orbits" << endl;
    cout << "Raising to level " << (int) current_level << ": Trying " << simplex_to_string(number_of_vertices, orbit_rep[number]) << " " << orbit_size[number] << "\n";
    /***** end writing log ****/
...
bool decrease_one_level() {
    ...
    /***** writing log ****/
    cout << "Returning to level " << (int) (current_level - 1) << "\n";
    /***** end writing log ****/
...
void triangulation_found () {
    ...
    cout << orbits_taken.size() << " orbits, " << current_number_of_maximal_simplices << " simplices" << endl;
